  ...
  ngOnInit() {
    this.items = [
      ...
      },
      {
        ...
        label: 'Hệ thống',
        icon: 'pi-cog',
        routerLink: '/mb-ageas/config-system',
        active: false,
        path: null,
      },
      {
        ...
        children: [
          {
            ...
            icon: 'pi-sign-in',
            routerLink: '/mb-ageas/employee/teacher',
            active: false,
          },
          {
            id: uuIdv4(),
            ...
            icon: 'pi-sign-in',
            routerLink: '/mb-ageas/employee/student',
            active: false,
          },
        ],
      },
...

      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: 'pi-sign-in',
            routerLink: '/mb-ageas/administration/newcategory',
            active: false,
          },
          {
            id: uuIdv4(),
            ...
            icon: 'pi-sign-in',
            routerLink: '/mb-ageas/administration/new',
            active: false,
          },
        ],
      },
